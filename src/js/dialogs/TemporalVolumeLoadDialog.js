...
// #include ../../uispecs/TemporalVolumeLoadDialog.json

class TemporalVolumeLoadDialog extends AbstractDialog {

constructor(options) {
    super(UISPECS.TemporalVolumeLoadDialog, options);
...
_loadDemoJson() {
    ...
    xhr.open('GET', 'demo-temporal-volumes.json');
    xhr.send();
}
...
_handleLoadFile() {
    ...
    const frames = this._binds.frames.getValue();
